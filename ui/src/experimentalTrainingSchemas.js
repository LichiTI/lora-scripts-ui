// experimentalTrainingSchemas.js — 实验/蒸馏训练 SECTIONS
// LAB Distiller / SDXL Turbo LCM / DiT few-step（Anima / Newbie）
// 从 sdxlSchema.js 抽出（阶段 2a）。
import { sec } from './schemaFieldGroups.js';
import { when } from './schemaCommon.js';
